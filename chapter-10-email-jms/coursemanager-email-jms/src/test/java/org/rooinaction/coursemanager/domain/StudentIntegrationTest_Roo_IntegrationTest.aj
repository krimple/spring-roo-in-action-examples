...
import org.rooinaction.coursemanager.domain.StudentIntegrationTest;
...
privileged aspect StudentIntegrationTest_Roo_IntegrationTest {
    ...
    public void StudentIntegrationTest.testFindStudent() {
        ...
        Assert.assertEquals("Find method for 'Student' returned the incorrect identifier", id, obj.getId_());
    }
    ...
    public void StudentIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Student' identifier to be null", obj.getId_());
        obj.persist();
        obj.flush();
        Assert.assertNotNull("Expected 'Student' identifier to no longer be null", obj.getId_());
    }
