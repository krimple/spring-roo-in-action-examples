...
public class InstructorMobileListView extends InstructorMobileListView_Roo_Gwt {
    ...
    private static InstructorMobileListView instance;
    ...
    public static InstructorMobileListView instance() {
        if (instance == null) {
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<InstructorProxy> {
        ...
        private final Renderer<InstructorProxy> primaryRenderer = org.rooinaction.coursemanager.client.managed.ui.renderer.InstructorProxyRenderer.instance();
