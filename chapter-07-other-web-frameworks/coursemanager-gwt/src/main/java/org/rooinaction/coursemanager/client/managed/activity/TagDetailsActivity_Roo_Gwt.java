...
import org.rooinaction.coursemanager.client.managed.ui.TagDetailsView.Delegate;
...
public abstract class TagDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<TagProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected TagDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.tagRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
