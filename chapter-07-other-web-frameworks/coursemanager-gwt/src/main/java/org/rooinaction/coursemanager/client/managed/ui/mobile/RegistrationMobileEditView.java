...
public class RegistrationMobileEditView extends RegistrationMobileEditView_Roo_Gwt {
    ...
    private static RegistrationMobileEditView instance;
    ...
    public RegistrationMobileEditView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static RegistrationMobileEditView instance() {
        if (instance == null) {
            instance = new RegistrationMobileEditView();
        }
        return instance;
    }

    @Override
    public RequestFactoryEditorDriver<RegistrationProxy, RegistrationMobileEditView> createEditorDriver() {
    ...
    interface Binder extends UiBinder<HTMLPanel, RegistrationMobileEditView> {
    }

    interface Driver extends RequestFactoryEditorDriver<RegistrationProxy, RegistrationMobileEditView> {
    }
}
