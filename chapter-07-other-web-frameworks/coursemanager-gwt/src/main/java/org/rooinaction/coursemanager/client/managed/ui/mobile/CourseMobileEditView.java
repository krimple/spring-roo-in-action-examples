...
public class CourseMobileEditView extends CourseMobileEditView_Roo_Gwt {
    ...
    private static CourseMobileEditView instance;
    ...
    public static CourseMobileEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<CourseProxy, CourseMobileEditView> createEditorDriver() {
