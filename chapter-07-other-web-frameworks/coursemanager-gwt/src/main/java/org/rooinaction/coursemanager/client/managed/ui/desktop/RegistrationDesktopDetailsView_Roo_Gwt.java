...
public abstract class RegistrationDesktopDetailsView_Roo_Gwt extends Composite implements RegistrationDetailsView {
    ...
    public void setValue(RegistrationProxy proxy) {
        ...
        displayRenderer.setInnerText(org.rooinaction.coursemanager.client.managed.ui.renderer.RegistrationProxyRenderer.instance().render(proxy));
    }
}
