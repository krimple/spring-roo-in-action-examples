...
public abstract class TrainingProgramDesktopDetailsView_Roo_Gwt extends Composite implements TrainingProgramDetailsView {
    ...
    public void setValue(TrainingProgramProxy proxy) {
        ...
        displayRenderer.setInnerText(org.rooinaction.coursemanager.client.managed.ui.renderer.TrainingProgramProxyRenderer.instance().render(proxy));
    }
}
