...
public class OfferingMobileEditView extends OfferingMobileEditView_Roo_Gwt {
    ...
    private static OfferingMobileEditView instance;
    ...
    public static OfferingMobileEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<OfferingProxy, OfferingMobileEditView> createEditorDriver() {
