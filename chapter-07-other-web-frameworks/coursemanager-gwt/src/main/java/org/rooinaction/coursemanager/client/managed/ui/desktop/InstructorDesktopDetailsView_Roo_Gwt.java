...
public abstract class InstructorDesktopDetailsView_Roo_Gwt extends Composite implements InstructorDetailsView {
    ...
    public void setValue(InstructorProxy proxy) {
        ...
        displayRenderer.setInnerText(org.rooinaction.coursemanager.client.managed.ui.renderer.InstructorProxyRenderer.instance().render(proxy));
    }
}
