...
import org.rooinaction.coursemanager.client.managed.ui.InstructorDetailsView.Delegate;
...
public abstract class InstructorDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {
    ...
    protected EntityProxyId<InstructorProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected InstructorDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.instructorRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
