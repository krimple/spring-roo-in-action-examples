...
public class CourseMobileListView extends CourseMobileListView_Roo_Gwt {
    ...
    private static CourseMobileListView instance;
    ...
    public static CourseMobileListView instance() {
        if (instance == null) {
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<CourseProxy> {
        ...
        private final Renderer<CourseProxy> primaryRenderer = org.rooinaction.coursemanager.client.managed.ui.renderer.CourseProxyRenderer.instance();
