...
public class InstructorMobileEditView extends InstructorMobileEditView_Roo_Gwt {
    ...
    private static InstructorMobileEditView instance;
    ...
    public static InstructorMobileEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<InstructorProxy, InstructorMobileEditView> createEditorDriver() {
