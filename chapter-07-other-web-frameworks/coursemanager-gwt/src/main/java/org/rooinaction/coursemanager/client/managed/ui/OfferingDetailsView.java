...
public class OfferingDetailsView extends OfferingDetailsView_Roo_Gwt {
    ...
    private static org.rooinaction.coursemanager.client.managed.ui.OfferingDetailsView instance;
    ...
    public OfferingDetailsView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static org.rooinaction.coursemanager.client.managed.ui.OfferingDetailsView instance() {
        if (instance == null) {
            instance = new OfferingDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, OfferingDetailsView> {
    }
}
