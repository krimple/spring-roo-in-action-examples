...
public class StudentMobileEditView extends StudentMobileEditView_Roo_Gwt {
    ...
    private static StudentMobileEditView instance;
    ...
    public static StudentMobileEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<StudentProxy, StudentMobileEditView> createEditorDriver() {
