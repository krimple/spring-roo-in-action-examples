...
public class OfferingEditView extends OfferingEditView_Roo_Gwt {
    ...
    private static org.rooinaction.coursemanager.client.managed.ui.OfferingEditView instance;
    ...
    public OfferingEditView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static org.rooinaction.coursemanager.client.managed.ui.OfferingEditView instance() {
        if (instance == null) {
            instance = new OfferingEditView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, OfferingEditView> {
    }

    interface Driver extends RequestFactoryEditorDriver<OfferingProxy, OfferingEditView> {
    }
}
