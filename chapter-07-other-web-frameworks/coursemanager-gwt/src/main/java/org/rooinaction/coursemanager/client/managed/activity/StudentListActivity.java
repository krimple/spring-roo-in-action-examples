...
public class StudentListActivity extends StudentListActivity_Roo_Gwt {
    ...
    public StudentListActivity(ApplicationRequestFactory requests, ProxyListView<org.rooinaction.coursemanager.proxy.StudentProxy> view, PlaceController placeController) {
    ...
    protected Request<java.util.List<org.rooinaction.coursemanager.proxy.StudentProxy>> createRangeRequest(Range range) {
