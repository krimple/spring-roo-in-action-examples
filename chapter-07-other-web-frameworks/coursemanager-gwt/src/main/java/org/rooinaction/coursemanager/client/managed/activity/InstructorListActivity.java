...
public class InstructorListActivity extends InstructorListActivity_Roo_Gwt {
    ...
    public InstructorListActivity(ApplicationRequestFactory requests, ProxyListView<InstructorProxy> view, PlaceController placeController) {
    ...
    protected Request<List<InstructorProxy>> createRangeRequest(Range range) {
