 ...
 * {@link org.rooinaction.coursemanager.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link org.rooinaction.coursemanager.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link org.rooinaction.coursemanager.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
