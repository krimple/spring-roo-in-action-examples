...
privileged aspect OfferingDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    private CourseDataOnDemand OfferingDataOnDemand.courseDataOnDemand;
    ...
    public void OfferingDataOnDemand.setCourse(Offering obj, int index) {
    ...
    public void OfferingDataOnDemand.init() {
        ...
        if (data == null) throw new IllegalStateException("Find entries implementation for 'Offering' illegally returned null");
        if (!data.isEmpty()) {
            return;
        }
        
        data = new ArrayList<org.rooinaction.coursemanager.model.Offering>();
        for (int i = 0; i < 10; i++) {
