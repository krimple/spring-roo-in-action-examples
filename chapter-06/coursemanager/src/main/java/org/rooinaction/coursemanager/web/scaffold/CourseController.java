...
/**
 * This controller was generated by pushing in the code from a scaffold, then
 * replacing the views with Spring form-tag views and AJAX calls and components
 * using the Dojo framework.  It can be re-skinned with jQuery since the data
 * is just JSON data.
 */
...
public class CourseController {
    ...
    /**
     * This is the ajax method used to fetch all courses.  We use the <code>@RooJson</code>
     * attribute on the Course entity to provide the data for the list.
     *
     * @see @RooJson
     * @return @ResponseBody items to display in JSON String array format.
     */
    @RequestMapping(value = "/listdata", method = RequestMethod.GET)
    public @ResponseBody
    String listData() {
        return Course.toJsonArray(Course.findAllCourses());
    }
