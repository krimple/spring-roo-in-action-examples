...
privileged aspect CourseController_Roo_Controller {
    ...
    public String CourseController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("courses", Course.findCourseEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
    ...
    void CourseController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("course_createddate_date_format", DateTimeFormat.patternForStyle("S-", LocaleContextHolder.getLocale()));
    }
