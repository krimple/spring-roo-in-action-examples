...
privileged aspect PizzaOrderPk_Roo_Json {
    ...
    public java.lang.String PizzaOrderPk.toJson() {
        return new JSONSerializer().exclude("*.class").serialize(this);
    }
    
    public static PizzaOrderPk PizzaOrderPk.fromJsonToPizzaOrderPk(java.lang.String json) {
        return new JSONDeserializer<PizzaOrderPk>().use(null, PizzaOrderPk.class).deserialize(json);
    }
    
    public static java.lang.String PizzaOrderPk.toJsonArray(Collection<PizzaOrderPk> collection) {
        return new JSONSerializer().exclude("*.class").serialize(collection);
    }
    
    public static Collection<PizzaOrderPk> PizzaOrderPk.fromJsonArrayToPizzaOrderPks(java.lang.String json) {
