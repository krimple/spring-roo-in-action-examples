...
privileged aspect PizzaOrder_Roo_Json {
    ...
    public static PizzaOrder PizzaOrder.fromJsonToPizzaOrder(java.lang.String json) {
        return new JSONDeserializer<PizzaOrder>().use(null, PizzaOrder.class).deserialize(json);
    }
    
    public static java.lang.String PizzaOrder.toJsonArray(Collection<PizzaOrder> collection) {
        return new JSONSerializer().exclude("*.class").deepSerialize(collection);
    }
    
    public static Collection<PizzaOrder> PizzaOrder.fromJsonArrayToPizzaOrders(java.lang.String json) {
