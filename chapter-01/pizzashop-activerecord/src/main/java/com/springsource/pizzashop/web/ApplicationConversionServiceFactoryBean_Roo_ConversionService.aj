...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Base, java.lang.String> ApplicationConversionServiceFactoryBean.getBaseToStringConverter() {
    ...
    public Converter<java.lang.Long, Base> ApplicationConversionServiceFactoryBean.getIdToBaseConverter() {
    ...
    public Converter<java.lang.String, Base> ApplicationConversionServiceFactoryBean.getStringToBaseConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.springsource.pizzashop.domain.Base>() {
            public com.springsource.pizzashop.domain.Base convert(String id) {
                return getObject().convert(getObject().convert(id, java.lang.Long.class), Base.class);
            }
        };
    }
    
    public Converter<Pizza, java.lang.String> ApplicationConversionServiceFactoryBean.getPizzaToStringConverter() {
    ...
    public Converter<java.lang.Long, Pizza> ApplicationConversionServiceFactoryBean.getIdToPizzaConverter() {
    ...
    public Converter<java.lang.String, Pizza> ApplicationConversionServiceFactoryBean.getStringToPizzaConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.springsource.pizzashop.domain.Pizza>() {
            public com.springsource.pizzashop.domain.Pizza convert(String id) {
                return getObject().convert(getObject().convert(id, java.lang.Long.class), Pizza.class);
            }
        };
    }
    
    public Converter<PizzaOrder, java.lang.String> ApplicationConversionServiceFactoryBean.getPizzaOrderToStringConverter() {
    ...
    public Converter<java.lang.String, PizzaOrder> ApplicationConversionServiceFactoryBean.getStringToPizzaOrderConverter() {
    ...
    public Converter<Topping, java.lang.String> ApplicationConversionServiceFactoryBean.getToppingToStringConverter() {
    ...
    public Converter<java.lang.Long, Topping> ApplicationConversionServiceFactoryBean.getIdToToppingConverter() {
    ...
    public Converter<java.lang.String, Topping> ApplicationConversionServiceFactoryBean.getStringToToppingConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.springsource.pizzashop.domain.Topping>() {
            public com.springsource.pizzashop.domain.Topping convert(String id) {
                return getObject().convert(getObject().convert(id, java.lang.Long.class), Topping.class);
            }
        };
    }
    
    public Converter<java.lang.String, PizzaOrderPk> ApplicationConversionServiceFactoryBean.getJsonToPizzaOrderPkConverter() {
    ...
    public Converter<PizzaOrderPk, java.lang.String> ApplicationConversionServiceFactoryBean.getPizzaOrderPkToJsonConverter() {
