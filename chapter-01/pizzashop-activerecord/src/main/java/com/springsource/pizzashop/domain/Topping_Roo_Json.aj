...
privileged aspect Topping_Roo_Json {
    ...
    public java.lang.String Topping.toJson() {
        return new JSONSerializer().exclude("*.class").deepSerialize(this);
    }
    
    public static Topping Topping.fromJsonToTopping(java.lang.String json) {
        return new JSONDeserializer<Topping>().use(null, Topping.class).deserialize(json);
    }
    
    public static java.lang.String Topping.toJsonArray(Collection<Topping> collection) {
        return new JSONSerializer().exclude("*.class").deepSerialize(collection);
    }
    
    public static Collection<Topping> Topping.fromJsonArrayToToppings(java.lang.String json) {
