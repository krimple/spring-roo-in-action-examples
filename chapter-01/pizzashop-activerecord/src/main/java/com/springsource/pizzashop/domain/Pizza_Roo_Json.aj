...
privileged aspect Pizza_Roo_Json {
    ...
    public java.lang.String Pizza.toJson() {
        return new JSONSerializer().exclude("*.class").deepSerialize(this);
    }
    
    public static Pizza Pizza.fromJsonToPizza(java.lang.String json) {
        return new JSONDeserializer<Pizza>().use(null, Pizza.class).deserialize(json);
    }
    
    public static java.lang.String Pizza.toJsonArray(Collection<Pizza> collection) {
        return new JSONSerializer().exclude("*.class").deepSerialize(collection);
    }
    
    public static Collection<Pizza> Pizza.fromJsonArrayToPizzas(java.lang.String json) {
